...
const snd_powerUp = new URL('/public/assets/sounds/snd_powerup.mp3', import.meta.url).href;
const snd_powerDown = new URL('/public/assets/sounds/snd_powerdown.mp3', import.meta.url).href;
const snd_growl = new URL('/public/assets/sounds/snd_growl.mp3', import.meta.url).href;

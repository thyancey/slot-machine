...
export const INITIAL_SPIN_TOKENS = 2;
...
export const tileGlossary: TileGlossary = {
  bat: { label: 'bat', img: AssetMap.Rbat, attributes: ['attack', 'creature'], effect: 'attack', value: 1, score: 250 },
  coins: { label: 'coins', img: AssetMap.Rcoins, attributes: ['money'], score: 1000 },
  crazy: { label: 'crazy', img: AssetMap.Rcrazy, attributes: ['buff'], score: 0 },
  flame: { label: 'flame', img: AssetMap.Rflame, attributes: ['attack'], effect: 'attack', value: 1.1, score: 250 },
  halo: { label: 'halo', img: AssetMap.Rhalo, attributes: ['buff'], effect: 'health', value: 10, score: 1000 },
  ...
  poison: { label: 'poison', img: AssetMap.Rpoison, attributes: ['attack'], effect: 'attack', value: 1.5, score: 200 },
  shield: { label: 'shield', img: AssetMap.Rshield, attributes: ['buff'], effect: 'defense', value: 1, score: 100 },
  slot_seven: { label: 'seven', img: AssetMap.R7, attributes: [], score: 700 },
  ...
  sword: { label: 'sword', img: AssetMap.Rsword, attributes: ['attack'], effect: 'attack', value: 2, score: 80 },
};
